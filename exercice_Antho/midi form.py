...
class Fenetre(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Société")
        self.resize(300,400)
        self.centralWidget=QWidget()
        self.setCentralWidget(self.centralWidget)
        

        self.boutton1= QPushButton("Ajouter un nouveau poste",self.centralWidget)
        self.boutton2= QPushButton("Ajouter nouvel employé",self.centralWidget)
        self.boutton3 = QPushButton("Traitement des données", self.centralWidget)
        self.boutton4 = QPushButton("Afficher les stats", self.centralWidget)


        self.boutton1.setStyleSheet("QWidget{background:cyan}")
        self.boutton2.setStyleSheet("QWidget{background:orange}")
        self.boutton3.setStyleSheet("QWidget{background:pink}")
        self.boutton4.setStyleSheet("QWidget{background:blue}")
        ...
        qvboxlayout.addWidget(self.boutton3)
        qvboxlayout.addWidget(self.boutton4)
    ...
    def start(self):
        ...
        self.boutton1.clicked.connect(self.start)
        self.window.show()
